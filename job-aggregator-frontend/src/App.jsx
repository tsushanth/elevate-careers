          ...
          <div className="hero-left">
            ...
            <div className="hero-ctas">
              <button className="hero-cta-google" onClick={() => setShowAuthModal(true)}>
                <svg className="hero-cta-google-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <button className="hero-cta-secondary" onClick={() => setShowAuthModal(true)}>Sign in with email</button>
            </div>
          </div>
